...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{route('display')}}"><i class="fa fa-circle-o text-red"></i> <span>Dispaly</span></a></li>
                <li><a href="{{route('store')}}"><i class="fa fa-circle-o text-green"></i> <span>Add Article</span></a></li>
                <li><a href="{{route('admin')}}"><i class="fa fa-circle-o text-yellow"></i> <span>Add Role & Setting</span></a></li>
                <li><a href="{{route('statistics')}}"><i class="fa fa-circle-o text-aqua"></i> <span>Statistics</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="{{config('app.name')}}">{{config('app.name')}}</a>.</strong> All rights
        reserved.
    </footer>
